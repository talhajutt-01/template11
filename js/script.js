...
Promise.all([fetchJson1, fetchJson2])
    .then(jsonDataArray => {
        ...
        const mergedData = Object.assign({}, ...jsonDataArray);
            ...
            updateContent(p0, mergedData.project.p0);
            updateContent(p1, mergedData.project.p1);
            updateContent(p2, mergedData.project.p2);
            updateContent(p3, mergedData.project.p3);
            updateContent(p4, mergedData.project.p4);
            updateContent(p5, mergedData.project.p5);
            updateContent(p6, mergedData.project.p6);
            updateContent(p7, mergedData.project.p7);
            updateContent(p8, mergedData.project.p8);
            updateContent(p9, mergedData.project.p9);
            updateContent(p10, mergedData.project.p10);
            updateContent(p11, mergedData.project.p11);
            updateContent(p12, mergedData.project.p12);
            updateContent(p13, mergedData.project.p13);
            updateContent(p14, mergedData.project.p14);
            ...
            updateBackgroundColor(g3, mergedData.color.project);
            updateBackgroundColor(g4, mergedData.color.project1);
